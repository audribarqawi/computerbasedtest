    ...
    <div class="left" style="background-color:<?php echo "$warna"; ?>"><img src="images/<?php echo $banner; ?>" style=" margin-left:0px;"></div>
    	<div class="right">
			<table width="100%" border="0" style="margin-top:10px">   
				...
				<tr><td><span class="user">Peserta Ujian </span></td></tr>
...
<ul>
	...
	<div id="myerror" class="alert alert-danger" role="alert" style=" font-size: 15px; font-style:bold; font-weight:normal; margin-left:-40px; padding-left:30px;">
    <?php 
