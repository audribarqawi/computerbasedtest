		...
		<form action="?&header5=yes" method="post">
            <div class="panel-default">
                <div class="panel-heading">
                    ...
                    <a href="http://www.blogspot.com" target="_blank"><span style="color: #1B06CF;"><?php echo $skull; ?>-CBT </span></a>  </h2>
                </div>
					...
					<div class="panel-body">
						<div class="inner-content">
							<div class="wysiwyg-content">
								...
								<p align="center"> <br><b>REVCO</b> on Internet : <br>							
									<br><a href="https://www.youtube.com/" target="_blank"><img src="images/youtube.png" width="60"></a> 
										&nbsp;&nbsp;&nbsp;&nbsp; 
										<a href="https://t.me/" target="_blank"><img src="images/telegram.png" width="30"></a> 
										&nbsp;&nbsp;&nbsp;&nbsp; 
										<a href="https://www.facebook.com/audribarqawi/" target="_blank"><img src="images/fb.png" width="30"> </a> 
										&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<?php } else { ?>
					<div class="panel-body">
						<?php 	echo " 
							...
							<br><font color=#675B80>
							<br>Setelah Anda berhasil LOGIN Ubah Password yang diberikan Proktor/Teknisi, guna kerahasiaan Akun Anda karena Username dan Password awal Anda belum rahasia (hasil pengumuman).
							</font>
						"; ?>
					</div>
					<div class="panel-footer" align="center">
...
<div id="headtop"  style="width:98%; margin:0px 15px 15px 15px; height:60px; background-color:#fffefb; 
	border-bottom-color:#e4e4e2; font-size:14px; padding:15px; text-align:center"><span style="color: #ff0000;"><?php echo strtoupper($skull); ?> </span>| <span style="color: #1B06CF;">suported by REVCO</span>
</div>
