...
<nav class="navbar navbar-default" style="background-color:#ffffff">
	<div class="container-fluid">
		...
		<div class="navbar-header" >
			...
			<a class="navbar-brand" ><span style="color:#0100EB"><b>SMK Muhammadiyah 04 Medan</span>
		</div>

		<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav">
		<li><a href="#" data-toggle="modal" data-target="#nama_folder"><span >Settings</span></a></li>
		<?php  if ($ubahpass=="1"){?>
				<li><a href="#" data-toggle="modal" data-target="#ubahpassword"><span>Ubah Password</span></a></li>
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li><a href="./panel/pages/index.php">Login Sebagai Admin</a></li>
...
<a href="./panel/pages/index.php"><button type="button" class="btn btn-primary btn-small">Login Sebagai Admin</button></a>
...
<div style="margin-top:0px; bottom:50px; background-color:#dcdcdc; padding:7px; font-size:12px">
    <div class="content">
	<?php if ($teks3==""){echo "";}else{echo "";}?>  <center><strong> v4_rev1</strong><br>
	Modified @2022 by REVCO
		<br></center>
    </div>
</div>
<footer>
<div class="group" style="background-color:<?php echo $warna; ?>;">
    <div  style="background-color:<?php echo $warna; ?>; padding:7px; font-size:12px">
        <center><b><span style="color: #ff0000;"><?php echo strtoupper("$skull"); ?> </span></b> <br> <span style="color: #1B06CF;">Supported by REVCO</span></center>
    </div>
</footer>
